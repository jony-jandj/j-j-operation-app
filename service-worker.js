const CACHE_NAME = 'jj-operations-v76-cohesive-homeowner';
const APP_SHELL = ['./','./index.html','./selections-metadata.js','./jj-original-logo.png','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
